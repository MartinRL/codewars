...
namespace codewars
{
    ...
    public class MeanSquareErrorTests
    {
        ...
        public void VerifySolutionWith(int[] firstArray, int[] secondArray, double expectedAverage) => MeanSquareErrorSolution.Solution(firstArray, secondArray).Should().Be(expectedAverage);
    }
}
